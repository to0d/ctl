...
define dso_local noundef i32 @main() #4 {
  ...
  call void @__kmpc_push_num_threads(%struct.ident_t* @1, i32 %1, i32 3)
...
define internal void @.omp_outlined.(i32* noalias noundef %0, i32* noalias noundef %1) #5 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {

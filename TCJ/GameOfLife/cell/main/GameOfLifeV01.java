...
import alpha.game.cell.gameoflife.AboutDialog;
import alpha.game.cell.gameoflife.AlertBox;
import alpha.game.cell.gameoflife.CellGridCanvas;
import alpha.game.cell.gameoflife.EasyFile;
import alpha.game.cell.gameoflife.GameOfLife;
import alpha.game.cell.gameoflife.GameOfLifeControls;
import alpha.game.cell.gameoflife.GameOfLifeGrid;
import alpha.game.cell.gameoflife.LineEnumerator;
import alpha.game.cell.gameoflife.Shape;
import alpha.game.cell.gameoflife.ShapeCollection;
import alpha.game.cell.gameoflife.ShapeException;
import alpha.game.cell.gameoflife.TextFileDialog;
...
class AppletFrame extends Frame {
	 ...
	 *            applet to show
	 */
	public AppletFrame(String title, GameOfLifeV01 applet) {
		super(title);
		this.applet = applet;
	 ...
	 */
	private GameOfLifeV01 getStandaloneGameOfLife() {
		return (GameOfLifeV01) applet;
	}
 ...
 * @author Edwin Martin
 */
public class GameOfLifeV01 extends GameOfLife {
	...
	class GameOfLifeGridIO {
		...
		public Shape makeShape(String name, String text) {
			...
			Enumeration enumx = new LineEnumerator(text);
			while (enumx.hasMoreElements()) {
				String line = (String) enumx.nextElement();
		 ...
		 *            EasyFile-object
		 * @throws IOException
		 * @see alpha.game.cell.gameoflife.EasyFile
		 */
	...
	private static final long serialVersionUID = -1618001055441795973L;
	public static void main(String args[]) {
		...
		GameOfLifeV01 gameOfLife = new GameOfLifeV01();

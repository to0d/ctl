...
public class GameOfLifeGrid implements CellGrid {
	 ...
	 * 
	 * @see alpha.game.cell.gameoflife.CellGrid#getEnum()
	 */
	...
	public synchronized void next() {
		...
		// Reset cells
		enumx = currentShape.keys();
		while (enumx.hasMoreElements()) {
			cell = (Cell) enumx.nextElement();
			cell.neighbour = 0;
		}
		// Add neighbours
		...
		// Bury the dead
		// We are walking through an enum from we are also removing elements.
		// Can be tricky.
		enumx = currentShape.keys();
		while (enumx.hasMoreElements()) {
			cell = (Cell) enumx.nextElement();
	 ...
	 * 
	 * @see alpha.game.cell.gameoflife.CellGrid#resize(int, int)
	 */
